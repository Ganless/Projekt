    ...
    <body>
        <header id="Navbar">
            ...
            <div class="container">
                ...
                <form action="login.php" id="usersignup" name="usersignup" method="post">
                    <br>
                    <h2 class="form-signup-heading ">Logga in!</h2>
                    <br>
                    <input name="username" id="username" type="text" class="form-control" placeholder="Användarnamn" autofocus>
                    <br>
                    <input name="password2" id="password2" type="password" class="form-control" class="password2" placeholder="Lösenord">
                    <br>
                    <input type="submit" class="submit btn btn-lg btn-primary btn-default" name="submit" value="Logga in">
